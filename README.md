...
4. Qt5.15.19 MinGW810_1610_64         (Qt5.15使用官方默认编译器构建+小熊猫C++使用最新MinGW64构建)
...
4. Qt5.15.19 MinGW810_1610_64_RP       (Qt5.15使用官方默认编译器构建+小熊猫C++使用最新MinGW64构建)
5. Qt5.15.19 MinGW1610_64_RP(UCRT)

## Qt5.15.19 RP版本(32位)
1. Qt5.15.19 MinGW810_32_RP            (使用Qt5.15官方默认编译器版本)
2. Qt5.15.19 MinGW810_1610_32_RP       (Qt5.15使用官方默认编译器构建+小熊猫C++使用最新MinGW64构建)
